...
module.exports = {
  ...
  "entry": {
    ...
    "scripts": [
      "script-loader!./node_modules\\primeui\\primeui-ng-all.min.js"
    ],
    "styles": [
      "./src\\styles.css",
    ...
    "rules": [
      ...
      },
      {
        "exclude": [
          ...
          path.join(process.cwd(), "node_modules\\wfs-theme\\assets\\fonts\\Roboto\\css\\roboto\\roboto-fontface.css"),
          ...
          path.join(process.cwd(), "node_modules\\wfs-theme\\css\\WFS-primeng.css"),
          path.join(process.cwd(), "node_modules\\wfs-theme\\css\\WFS-ng2bootstrap.css"),
          path.join(process.cwd(), "node_modules\\wfs-theme\\css\\WFS-bootstrap.css")
        ],
        "test": /\.css$/,
        "loaders": [
  ...
  "plugins": [
    ...
    new GlobCopyWebpackPlugin({
      "patterns": [
        ...
        {
          "glob": "**/*",
          "input": "../node_modules/wfs-theme/assets",
          "output": "./assets/"
        }
      ],
      "globOptions": {
        "cwd": "C:\\Users\\zeus_ui\\src",
        "dot": true,
        "ignore": "**/.gitkeep"
      }
    }),
